...
# Monkey-patch for PyTorch 2.0+ compatibility with mmcv-full 1.6.0
...
# Monkey-patch for yapf compatibility in mmcv
try:
    import mmcv.utils.config as mmcv_config
    orig_format_code = mmcv_config.FormatCode
    def patched_format_code(*args, **kwargs):
        kwargs.pop('verify', None)
        return orig_format_code(*args, **kwargs)
    mmcv_config.FormatCode = patched_format_code
