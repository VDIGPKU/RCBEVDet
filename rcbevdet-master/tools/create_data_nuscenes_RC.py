...
def add_ann_adj_info(extra_tag):
	#Changed nuscenes_version, 'v1.0-trainval' -> 'v1.0-mini'
    nuscenes_version = 'v1.0-mini'
	#Changed root -> '.
    dataroot = '/mnt/datasets/nuscenes/'
    nuscenes = NuScenes(nuscenes_version, dataroot)
    #for set in ['train', 'val']:
    for set in ['train_mini', 'val_mini']:
        dataset = pickle.load(
...
if __name__ == '__main__':
    ...
    root_path = '/mnt/datasets/nuscenes'
	#nuscenes_RC -> nuscenes_mini
    extra_tag = 'nuscenes' #nuscenes_R
    nuscenes_data_prep(
        root_path=root_path,
