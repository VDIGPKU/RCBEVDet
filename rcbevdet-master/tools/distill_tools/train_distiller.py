...
from mmdet3d.apis import init_random_seed, train_distill_model
from mmdet3d.datasets import build_dataset
from mmdet3d.models import build_algorithm
...
def main():
    ...
    # TODO: only support mmdet-distill for now
    logger_name = 'mmdet-distill'
