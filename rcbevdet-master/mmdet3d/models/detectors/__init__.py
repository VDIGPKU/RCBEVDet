...
from .bevdet import BEVDepth4D, BEVDet, BEVDet4D, BEVDetTRT, BEVStereo4D, BEVDepth4D_d2t
from .bevdet_rc import BEVDet_RC, BEVDet4D_RC, BEVDepth4D_RC, BEVStereo4D_RC
...
__all__ = [
    ...
    'BEVDetTRT', 'BEVStereo4D', 'FUTR3D', 'BEVDepth4D_d2t',
    'BEVDet_RC', 'BEVDet4D_RC', 'BEVDepth4D_RC', 'BEVStereo4D_RC'
]
