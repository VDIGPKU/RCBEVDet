import os
from ..vod_utils import evaluation_common as kitti
...
class Evaluation:
    ...
    def evaluate(self,
        ...
        evaluation_result = {}
        for name, result_files_ in dt_annotations.items():
            evaluation_result.update(get_official_eval_result(gt_annotations, result_files_, current_class, custom_method=0))
            evaluation_result.update(get_official_eval_result(gt_annotations, result_files_, current_class, custom_method=3))
